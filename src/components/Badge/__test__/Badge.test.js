  ...
  [
    {
      ...
      params: {},
      result: 'border-primary-600 text-primary-600 dark:border-primary-200 dark:text-primary-200'
    },
    {
      name: 'Should have colors based on variant gray',
      params: {variant: 'gray'},
      result: 'border-gray-600 text-gray-600 dark:border-gray-200 dark:text-gray-200'
    },
    {
    ...
    },
    {
      ...
      result: 'border-error-600 text-error-600 dark:border-error-200 dark:text-error-200'
    },
    {
    ...
    },
    {
      ...
      result: 'border-gray-500 bg-gray-500 text-primary-200'
    }
  ]
)
