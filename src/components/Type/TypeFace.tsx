...
export function TypeFace(props: ComponentProps<'typeface'>) {
  return (
    <>
      ...
      <hr />
      <h1 className="text-4xlarge my-4">Underlined</h1>
      <div className="flex flex-row mb-4">
        <div className="pr-4">
          <p className="text-small-bold mb-2 text-center">Regular</p>
          <p className="text-xsmall underline">XSmall</p>
          <p className="text-small underline">Small</p>
          <p className="text-medium underline">Medium</p>
          <p className="text-large underline">Large</p>
          <h1 className="text-xlarge underline">XLarge</h1>
          <h2 className="text-2xlarge underline">2XLarge</h2>
          <h3 className="text-3xlarge underline">3XLarge</h3>
          <h4 className="text-4xlarge underline">4XLarge</h4>
          <h5 className="text-5xlarge underline">5XLarge</h5>
          <h6 className="text-6xlarge underline">6XLarge</h6>
        </div>
        <div>
          <p className="text-small-bold mb-2 text-center">Bold</p>
          <p className="text-xsmall-bold underline">XSmall</p>
          <p className="text-small-bold underline">Small</p>
          <p className="text-medium-bold underline">Medium</p>
          <p className="text-large-bold underline">Large</p>
          <h1 className="text-xlarge-bold underline">XLarge</h1>
          <h2 className="text-2xlarge-bold underline">2XLarge</h2>
          <h3 className="text-3xlarge-bold underline">3XLarge</h3>
          <h4 className="text-4xlarge-bold underline">4XLarge</h4>
          <h5 className="text-5xlarge-bold underline">5XLarge</h5>
          <h6 className="text-6xlarge-bold underline">6XLarge</h6>
        </div>
      </div>
      <hr />
      <h1 className="text-4xlarge my-4">Uppercased</h1>
      <div className="flex flex-row mb-4">
        <div className="pr-4">
          <p className="text-small-bold mb-2 text-center">Regular</p>
      ...
      <hr />
      <h1 className="text-4xlarge my-4">Monospace</h1>
      <div className="flex flex-row mb-4">
        <div className="pr-4">
          <p className="text-small-bold mb-2 text-center">Regular</p>
